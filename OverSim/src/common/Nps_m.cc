...
CoordsReqCall::CoordsReqCall(const CoordsReqCall& other) : BaseCallMessage(other)
{
    copy(other);
}
...
void CoordsReqCall::copy(const CoordsReqCall& other)
{
}
...
CoordsReqResponse::CoordsReqResponse(const CoordsReqResponse& other) : BaseResponseMessage(other)
{
    copy(other);
}
...
void CoordsReqResponse::copy(const CoordsReqResponse& other)
{
...
void CoordsReqResponse::setLayer(char layer)
{
